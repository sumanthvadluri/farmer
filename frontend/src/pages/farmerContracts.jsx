...
import { useGetFarmerAcceptCropsQuery,useAddPastCropsMutation,useGetFarmerPastCropsQuery,useDeleteAcceptCropMutation} from '../redux/api/users';
...
const FarmerContracts = () => {
      ...
      const { data: cropss = [], errorr, issLoading, refetchh } = useGetFarmerPastCropsQuery();
        ...
        {selectedContract && (
          <div className="profile-overlay" onClick={closeProfile}>
            <div className="contract-profile-container" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="name">
                <h1><b>{selectedContract.buyerName}</b></h1>
