...
import { useGetRequestCropsQuery } from '../redux/api/users';
import CropDetailModal from '../components/ExpandableCard';

const RequestCrops = () => {
  const { userInfo } = useSelector((state) => state.auth);
  const navigate = useNavigate();
  const { data: crops = [], error, isLoading, refetch } = useGetRequestCropsQuery();
